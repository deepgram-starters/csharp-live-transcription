# csharp-live-transcription

C# (.NET) demo app for Deepgram Live Transcription.
...
```
feat(csharp-live-transcription): add diarization support
fix(csharp-live-transcription): resolve WebSocket close handling
refactor(csharp-live-transcription): simplify session endpoint
